...
var _server = "http://127.0.0.1:7359"; // const _server = config.fetchUrl;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 6;
          return regeneratorRuntime.awrap(fetch(_server + url, {
            method: method,
            headers: _headers,
            body: body
          }));
...
/* harmony import */ var _modules_calc_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/calc.js */ "./src/js/modules/calc.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_3__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_3__["default"])('.decoration_slider', '.no_click', '.decoration_content>div>div', 'after_click');
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_3__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block');
  Object(_modules_forms_js__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
...
var calc = function calc() {
  ...
  var exceptNumbers = function exceptNumbers(e) {
...
/* harmony import */ var _js_backend_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../js/backend.js */ "./src/js/js/backend.js");
/* harmony import */ var _checkNumInputs_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./checkNumInputs.js */ "./src/js/modules/checkNumInputs.js");
...
var _forms = function _forms(state) {
  var forms = document.querySelectorAll('form');
  var inputs = document.querySelectorAll('input');
  Object(_checkNumInputs_js__WEBPACK_IMPORTED_MODULE_11__["default"])('input[name="user_phone"]');
  var clearUserInput = true;
  var messege = {
    loading: 'Загрузка',
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(Object(_js_backend_js__WEBPACK_IMPORTED_MODULE_10__["request"])(url, 'POST', data));
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      var userName = form.querySelector('input[name="user_name"]').value;
      var userPhone = form.querySelector('input[name="user_phone"]').value;
      var formData = {
        user_name: userName,
      ...
      if (form.getAttribute('data-calc') === 'end') {
        formData.calcValue = _objectSpread({}, state);
        console.log(formData);
      }

      statusMessege.textContent = messege.loading;
      postData('/delay4', formData).then(function (res) {
        if (res !== undefined) {
...
/* harmony default export */ __webpack_exports__["default"] = (_forms);
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: bindModal, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var bindModal = function bindModal(triggerSelector, modalSelector, closeSelector) {
  ...
  triggers.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      var closeModal_btn = function closeModal_btn() {
        windows.forEach(function (item) {
      ...
      var closeModal_modal = function closeModal_modal(e) {
...
var showModalByTimeout = function showModalByTimeout(selector, time) {
  setTimeout(function () {
...
var modals = function modals() {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTimeout( '.popup', 60000 );
};
...
var tabs = function tabs(headerSelector, tabSelsector, contentSelector, activeClass) {
  var activeDisplay = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  ...
  header.addEventListener('click', function (e) {
    var target = e.target;
    var tab_selsector = tabSelsector.replace(/\./, '');
    var state = target && (target.classList.contains(tab_selsector) || target.parentNode.classList.contains(tab_selsector));
